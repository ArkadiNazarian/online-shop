        ...
        <div className="tw-h-screen tw-flex-col tw-flex tw-justify-center tw-items-center">
            <div className="tw-bg-custom_gray tw-w-96 tw-flex tw-flex-col tw-items-center tw-border-none tw-rounded-3xl">
                ...
                <form onSubmit={props.action_submit}>
                    ...
                    <button type="submit" className="tw-mt-8 tw-bg-custom_yellow tw-border-none tw-font-medium tw-rounded-lg tw-text-sm tw-w-44  tw-px-5 tw-py-2.5 tw-text-center ">Reset</button>
                    <p className="tw-text-custom_white tw-text-base"><Link to={props.sign_in} className="tw-text-base tw-text-custom_yellow tw-ml-1">Sign In</Link></p>
