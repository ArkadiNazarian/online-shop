    ...
    <div className="tw-relative">
        <div className="tw-grid tw-grid-cols-6 tw-mb-16">
            ...
            <div className="tw-flex tw-flex-row tw-ml-10 tw-col-start-3 tw-mt-8">
                <p className={`tw-text-xl tw-font-semibold tw-px-6 tw-rounded-2xl tw-py-4 tw-text-custom_gray ${props.on_pages.home && "tw-bg-custom_gray tw-text-custom_white"}`}>Home</p>
                <div className="tw-relative tw-group tw-text-xl tw-px-6 tw-rounded-2xl tw-py-4 tw-font-semibold tw-text-custom_gray hover:tw-cursor-pointer" onClick={() => props.handler_onView_products()}>Categories
                    <div className="group-hover:tw-opacity-100 tw-opacity-0 tw-duration-700 tw-absolute tw-bg-white tw-top-14 tw-z-20 tw-rounded-lg">
                ...
                <p className="tw-text-xl tw-font-semibold tw-px-6 tw-rounded-2xl tw-py-4 tw-text-custom_gray">Products</p>
            </div>
