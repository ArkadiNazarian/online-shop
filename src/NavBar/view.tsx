    ...
    <div className="tw-w-screen tw-relative">
        <div className="tw-grid tw-grid-cols-6 tw-mb-16">
            ...
            <div className="tw-flex tw-flex-row tw-ml-10 tw-col-start-3 tw-mt-8">
                ...
                <div className="tw-relative tw-group tw-text-xl tw-font-semibold tw-text-custom_gray hover:tw-cursor-pointer" onClick={() => props.handler_onView_products()}>Products
