                ...
                <div className="tw-bg-custom_gray tw-w-96 tw-flex tw-flex-col tw-items-center tw-border-none tw-rounded-3xl">
                    ...
                    <form onSubmit={props.action_submit}>
                        <div className="tw-relative">
                            ...
                            />
                            <label data-testid="first_name-lable" htmlFor="first_name" className={`tw-text-custom_background ${props.form_data.first_name ? 'tw--top-4 tw-text-sm' : 'peer-focus:tw-text-sm peer-focus:tw--top-4 tw-text-lg'} tw-absolute tw-left-0 tw-transition-all`}>First name</label>
                        ...
                        <div className="tw-relative tw-mt-8">
                            <input
                                ...
                                onChange={props.handleChange}
                                onBlur={props.handleBlur}
                                data-testid="lasr_name-input"
                            />
                            <label data-testid="last_name-lable" htmlFor="last_name" className={`tw-text-custom_background ${props.form_data.last_name ? 'tw--top-4 tw-text-sm' : 'peer-focus:tw-text-sm peer-focus:tw--top-4 tw-text-lg'} tw-absolute tw-left-0 tw-transition-all`}>Last name</label>
                        ...
                        <div className="tw-relative tw-mt-8">
                            ...
                            />
                            <label data-testid="email-lable" htmlFor="email" className={`tw-text-custom_background ${props.form_data.email ? 'tw--top-4 tw-text-sm' : 'peer-focus:tw-text-sm peer-focus:tw--top-4 tw-text-lg'} tw-absolute tw-left-0 tw-transition-all`}>Email</label>
                        ...
                        <div className="tw-relative tw-mt-8">
                            <input
                                ...
                                className="tw-py-1 tw-mt-1 tw-w-64 tw-border-t-0 tw-bg-custom_gray tw-border-l-0 tw-border-r-0 tw-border-b-custom_black tw-border-b focus:tw-outline-none tw-transition-colors tw-peer"
                            />
                            <label data-testid="password-lable" htmlFor="password" className={`tw-text-custom_background ${props.form_data.password ? 'tw--top-4 tw-text-sm' : 'peer-focus:tw-text-sm peer-focus:tw--top-4 tw-text-lg'} tw-absolute tw-left-0 tw-transition-all`}>Password</label>
